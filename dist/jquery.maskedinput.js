        ...
        mask: function(mask, settings) {
            ...
            firstNonMaskPos = null, $.each(mask.split(""), function(i, c) {
                ...
                function writeBuffer() {
                    var i, val = "";
                    if (settings.displayMask) input.val(buffer.join("")); else {
                        for (i = 0; i < buffer.length && (!tests[i] || tests[i].test(buffer[i])); i++) val += buffer[i];
                        input.val(val);
                    }
                }
                function checkVal(allow) {
                    ...
                    } else allow && i !== partialPosition ? lastMatch = i : buffer[i] === test.charAt(pos) && i !== partialPosition && (pos++, 
                    lastMatch = i);
                    ...
                    lastMatch >= 0 ? lastMatch + 1 : firstNonMaskPos;
                }
